...
import '../../shared/assets/assets_path.dart';
import '../../theme/theme_extensions/app_color_scheme.dart';
import '../../theme/theme_extensions/app_sidebar_theme.dart';
import '../sidebar/configs/menu_configs.dart';
import '../sidebar/sidebar_home.dart';
      ...
      child: GestureDetector(
        ...
        child: Row(
          ...
          children: [
            ...
            const Text("PACE SETTER MANAGEMENT DASHBOARD"),
          ],
        ),
      ),
    );
