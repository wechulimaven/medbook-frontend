  ...
  factory AppButtonTheme.fromAppColorScheme(AppColorScheme appColorScheme) {
    return AppButtonTheme(
      ...
      secondaryElevated: ElevatedButton.styleFrom(
        ...
        disabledForegroundColor: appColorScheme.secondary.withOpacity(0.38),
        disabledBackgroundColor: appColorScheme.secondary.withOpacity(0.12),
      ).withCommonButtonStyle(
        appColorScheme: appColorScheme,
      ),
      errorElevated: ElevatedButton.styleFrom(
        backgroundColor: appColorScheme.error,
        disabledForegroundColor: appColorScheme.error.withOpacity(0.38),
        disabledBackgroundColor: appColorScheme.error.withOpacity(0.12),
      ).withCommonButtonStyle(
        appColorScheme: appColorScheme,
      ),
      successElevated: ElevatedButton.styleFrom(
        backgroundColor: appColorScheme.success,
        disabledForegroundColor: appColorScheme.success.withOpacity(0.38),
        disabledBackgroundColor: appColorScheme.success.withOpacity(0.12),
      ).withCommonButtonStyle(
        appColorScheme: appColorScheme,
      ),
      infoElevated: ElevatedButton.styleFrom(
        backgroundColor: appColorScheme.info,
        disabledForegroundColor: appColorScheme.info.withOpacity(0.38),
        disabledBackgroundColor: appColorScheme.info.withOpacity(0.12),
      ).withCommonButtonStyle(
        appColorScheme: appColorScheme,
      ),
      warningElevated: ElevatedButton.styleFrom(
        backgroundColor: appColorScheme.warning,
        disabledForegroundColor: appColorScheme.warning.withOpacity(0.38),
        disabledBackgroundColor: appColorScheme.warning.withOpacity(0.12),
      ).withCommonButtonStyle(
        appColorScheme: appColorScheme,
